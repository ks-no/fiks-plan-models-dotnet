...
using KS.Fiks.Plan.Models.V2.oppdatering.DispensasjonOppdaterTyper;
...
public class OppdaterDispensasjonTests : ModelTestsBase
{
    public OppdaterDispensasjonTests(ITestOutputHelper testOutputHelper)
    {
    ...
    public void Opprett_Og_Valider_Oppdater_Dispensasjon()
    {
        ...
        oppdaterDispensasjon.Dispensasjon = new Dispensasjon()
        {
            Identifikasjon = "1",
        ...
        var jsonString =
            JsonConvert.SerializeObject(oppdaterDispensasjon, new StringEnumConverter());
