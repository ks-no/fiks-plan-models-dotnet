...
public class Arealplan
{
    ...
    [Newtonsoft.Json.JsonProperty("vedtakEndeligPlandato", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    [Newtonsoft.Json.JsonConverter(typeof(DateFormatConverter))]
    public System.DateTimeOffset VedtakEndeligPlandato { get; set; }
    ...
    public ArealplanForslagsstillerType ForslagsstillerType { get; set; }

    [Newtonsoft.Json.JsonProperty("alternativFinnes", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public bool AlternativFinnes { get; set; }
