...
namespace KS.Fiks.Plan.Models.V2.innsyn.PlanerforomraadeResultat {
...
public class Arealplan
{
    ...
    [Newtonsoft.Json.JsonProperty("forslagstillerType", Required = Newtonsoft.Json.Required.Always)]
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
