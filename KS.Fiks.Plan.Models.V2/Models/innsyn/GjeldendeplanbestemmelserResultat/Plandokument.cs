namespace KS.Fiks.Plan.Models.V2.innsyn.GjeldendeplanbestemmelserResultat {
...
public class Plandokument
{
    ...
    [Newtonsoft.Json.JsonProperty("dokumenttype", Required = Newtonsoft.Json.Required.Always)]
    [System.ComponentModel.DataAnnotations.Required]
    public Dokumenttype Dokumenttype { get; set; } = new Dokumenttype();
    ...
    [Newtonsoft.Json.JsonProperty("arkivnavn", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
